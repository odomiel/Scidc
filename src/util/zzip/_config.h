...
/* zzip/_config.h - manually configured for Linux x86_64 / GCC */
/* Generated for zziplib 0.13.80 */
...
/* On Linux x86_64 with _FILE_OFFSET_BITS=64, off_t is 64-bit; map off64_t */
