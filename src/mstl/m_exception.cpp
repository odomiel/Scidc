...
basic_exception::basic_exception() noexcept :m_msg(new string) {}
...
basic_exception::~basic_exception() noexcept { delete m_msg; }

char const* basic_exception::what() const noexcept { return *m_msg; }
...
exception::exception() noexcept :m_report(new string), m_backtrace(isEnabled()) {}
...
exception::~exception() noexcept { delete m_report; }
