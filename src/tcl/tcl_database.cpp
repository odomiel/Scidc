...
static char const* CmdAttach			= "::scidc::db::attach";
static char const* CmdClear			= "::scidc::db::clear";
static char const* CmdClose			= "::scidc::db::close";
static char const* CmdCompact			= "::scidc::db::compact";
static char const* CmdCopy				= "::scidc::db::copy";
static char const* CmdCount			= "::scidc::db::count";
static char const* CmdFetch			= "::scidc::db::fetch";
static char const* CmdFind				= "::scidc::db::find";
static char const* CmdImport			= "::scidc::db::import";
static char const* CmdLoad				= "::scidc::db::load";
static char const* CmdNew				= "::scidc::db::new";
static char const* CmdSet				= "::scidc::db::set";
static char const* CmdGet				= "::scidc::db::get";
static char const* CmdMatch			= "::scidc::db::match";
static char const* CmdOpen				= "::scidc::db::open";
static char const* CmdPlayerCard		= "::scidc::db::playerCard";
static char const* CmdPlayerInfo		= "::scidc::db::playerInfo";
static char const* CmdRecode			= "::scidc::db::recode";
static char const* CmdReverse			= "::scidc::db::reverse";
static char const* CmdSave				= "::scidc::db::save";
static char const* CmdSavePGN			= "::scidc::db::savePGN";
static char const* CmdSort				= "::scidc::db::sort";
static char const* CmdSubscribe		= "::scidc::db::subscribe";
static char const* CmdSwitch			= "::scidc::db::switch";
static char const* CmdUnsubscribe	= "::scidc::db::unsubscribe";
static char const* CmdUpdate			= "::scidc::db::update";
static char const* CmdUpgrade			= "::scidc::db::upgrade";
static char const* CmdWrite			= "::scidc::db::write";
