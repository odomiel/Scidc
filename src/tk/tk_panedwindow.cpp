...
static const Tk_OptionSpec optionSpecs[] = {
    {TK_OPTION_BORDER, "-background", "background", "Background",
	 ...
	 static_cast<ClientData>(DEF_PANEDWINDOW_BG_MONO), 0},
    {TK_OPTION_SYNONYM, "-bd", NULL, NULL,
	 NULL, 0, -1, 0, static_cast<ClientData>("-borderwidth"), 0},
    {TK_OPTION_SYNONYM, "-bg", NULL, NULL,
	 NULL, 0, -1, 0, static_cast<ClientData>("-background"), 0},
    ...
    {TK_OPTION_STRING_TABLE, "-orient", "orient", "Orient",
	 ...
	 0, static_cast<ClientData>(orientStrings), GEOMETRY},
    {TK_OPTION_BORDER, "-proxybackground", "proxyBackground", "ProxyBackground",
	 ...
	 static_cast<ClientData>(DEF_PANEDWINDOW_BG_MONO)},
...
static const Tk_OptionSpec slaveOptionSpecs[] = {
	...
	static_cast<ClientData>(stretchStrings), 0},
