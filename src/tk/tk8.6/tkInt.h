...
MODULE_SCOPE __attribute__((visibility("hidden"))) const Tcl_ObjType tkBorderObjType;
MODULE_SCOPE __attribute__((visibility("hidden"))) const Tcl_ObjType tkBitmapObjType;
MODULE_SCOPE __attribute__((visibility("hidden"))) const Tcl_ObjType tkColorObjType;
MODULE_SCOPE __attribute__((visibility("hidden"))) const Tcl_ObjType tkCursorObjType;
MODULE_SCOPE __attribute__((visibility("hidden"))) const Tcl_ObjType tkFontObjType;
MODULE_SCOPE __attribute__((visibility("hidden"))) const Tcl_ObjType tkStateKeyObjType;
MODULE_SCOPE __attribute__((visibility("hidden"))) const Tcl_ObjType tkTextIndexType;
...
MODULE_SCOPE __attribute__((visibility("hidden"))) const Tk_SmoothMethod tkBezierSmoothMethod;
MODULE_SCOPE __attribute__((visibility("hidden"))) Tk_ImageType	tkBitmapImageType;
MODULE_SCOPE __attribute__((visibility("hidden"))) Tk_PhotoImageFormat tkImgFmtGIF;
MODULE_SCOPE void		(*tkHandleEventProc) (XEvent* eventPtr);
MODULE_SCOPE __attribute__((visibility("hidden"))) Tk_PhotoImageFormat tkImgFmtPNG;
MODULE_SCOPE __attribute__((visibility("hidden"))) Tk_PhotoImageFormat tkImgFmtPPM;
MODULE_SCOPE TkMainInfo		*tkMainWindowList;
MODULE_SCOPE __attribute__((visibility("hidden"))) Tk_ImageType	tkPhotoImageType;
MODULE_SCOPE __attribute__((visibility("hidden"))) Tcl_HashTable	tkPredefBitmapTable;
