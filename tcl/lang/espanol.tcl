...
### themes #############################################################
::scidc::themes::mc::CannotOverwriteTheme	"No se puede anular el tema %s."
...
::menu::mc::OrdinaryMonitor				"Monitor normal (claro)"
::menu::mc::HighQualityMonitor			"Monitor de alta calidad (claro)"
...
::menu::mc::AboutScidb						"A&cerca de Scidc"
