...
set FeatureDetail(antichess)			"Antichess is a chess variant where the goal is to lose all pieces. Captures are mandatory and there is no check. In case of stalemate, the stalemated player wins (Lichess rules)."
...
set Feature(antichess)		"Antichess"
